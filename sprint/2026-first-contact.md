...
Four of the six spokes are dormant by ruling and the rest are clean; a repo-keyed stack would list six rows of nothing. The fall's work happens on **surfaces**, two of which have no repo behind them ([[../wiki/decisions]] 2026-08-23).
...
| — | **Civics tool** | Facilitator | Two ratifications pending (source anchor, intake source field). Reconcile ceiling applies ([[../wiki/decisions]] 2026-08-23): no build without going through [[../initiatives/issue-ledger]]'s gate. |
