...
# Pure functions (no git, no console) for drift-check and repo-state.
#
# The generator half (Get-SourceHash, Format-ModuleFactsJson,
# Format-ContextMarkdown) was removed 2026-07-26 with the .hub pipeline it
# served -- that pipeline never ran in a single spoke. Git history has it if
# a real fan-out ever reappears.
...
Export-ModuleMember -Function ConvertFrom-ModuleFacts, ConvertFrom-GitStatus, Get-SpokePaths
