...
| [[operator/index]] | The operator: [[operator/ai-collaboration-context]] (role, students, constraints, goals, oath clauses) and [[operator/build-inventory]] (one row per artifact that exists). Moved from the root on 2026-09-22. The "root-level by necessity" note was wrong, because D-2026-08-23 cites the file by bare filename, not by path |
...
| `archive/` | Closed sprints, closed event schedules (for example [[archive/hackathon-26-day-schedule]]), and concluded-arc research. Historical, never canonical |
