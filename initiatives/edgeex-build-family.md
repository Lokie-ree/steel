...
**Current state (2026-07-24):** Two-build slate, with a gate between them ([[../wiki/decisions]] 2026-07-22 — fewer, deeper).

1. **transformations-ptr** (`F-BF.B.3`) — **shipped 2026-07-24** (course-lab PR #16), live in production. Four rounds → earned sandbox, quadratic + absolute value, families as data; spec `docs/superpowers/specs/2026-07-19-transformations-ptr-design.md`, plan `docs/superpowers/plans/PLAN-course-lab-transformations-ptr.md`, home ruled **course-lab** ([[../wiki/decisions]] 2026-07-19). It shipped as specced; a third family is scope creep, not depth. What remains is running it with students.
